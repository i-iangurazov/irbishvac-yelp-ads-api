...
export const yelpLeadDetailSchema = z
  .object({
    ...
    phone_number: z.string().nullish(),
    temporary_phone_number: z.string().nullish(),
    phone_number_expires_at: z.string().nullish(),
    phone_number_expiry: z.string().nullish(),
    temporary_phone_number_expires_at: z.string().nullish(),
    temporary_phone_number_expiry: z.string().nullish(),
    temporary_phone_number_expiration: z.string().nullish(),
    masked_phone_number: z.string().nullish(),
    temporary_email_address: z.string().optional(),
