        ...
        <div className="grid gap-6">
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Use these for the live operator workflow. Ads uses partner basic
                auth; Leads and other Yelp bearer-auth reads use the access
                token.
              </p>
            </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Keep these for restricted helper flows and future integrations.
                They are not the primary live path today.
              </p>
            </div>
            <SettingsCredentialForm
              kind="BUSINESS_MATCH"
      ...
      <Card className="mt-6">
        <CardHeader>
          ...
          <CardDescription>
            ...
            assist, and delivery health now live in the dedicated autoresponder
            workspace.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-lg border border-border/80 bg-muted/10 p-4">
              ...
              <div className="mt-2 text-sm font-medium">
                {automation.aiAssist.enabled ? "Enabled" : "Disabled"} • Review
                required
              </div>
              <div className="mt-1 text-xs text-muted-foreground">
