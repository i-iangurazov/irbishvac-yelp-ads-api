...
const capabilitySections = [
  {
    ...
    description:
      "Enable these only when the tenant can use the current production flows end to end.",
    keys: [
      "hasAdsApi",
      "hasLeadsApi",
      "hasReportingApi",
    ...
    ] as Array<keyof CapabilityFlags>,
  },
  {
    title: "Restricted and future capabilities",
    description:
      "These flags cover optional partner access, future integrations, or local testing paths. They should not imply a broader live workflow by themselves.",
    keys: [
    ...
    try {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : "Unable to save capability flags.",
      );
    }
  });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Enable only the surfaces that are actually available in this
          environment.
        </CardDescription>
      </CardHeader>
      <CardContent>
                  ...
                  >
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setValue(definition.key, checked)
                      }
                    />
                  </Label>
                );
